...
## HTML TAG under which table data is in <table class="engineTable"> == $0

def team_test_data_extraction(format_type):

    ## We have removed the list of these following teams because they do not have data in test matches  -{ '29':'Ireland', '28': 'Namibia', '33': 'Nepal','15': 'Netherlands','37':'Oman', '20': 'Papua New Guinea', '30': 'Scotland', '27': 'UAE', '11': 'USA'}
